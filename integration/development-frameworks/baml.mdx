...
Next, you'll modify the client registry to connect to Respan, enabling observability and analytics. Learn how to create a Respan API key [here](https://docs.keywordsai.co/get-started/llm-inference#1-get-your-keywords-ai-api-key).
...
Initialize a Respan client in BAML by switching the base URL and adding the RESPAN_API_KEY in the environmental variable. Learn how to create a Respan API key [here](https://docs.keywordsai.co/get-started/llm-inference#create-an-api-key).   
