...
- A [Respan API key](https://platform.keywordsai.co/platform/api/api-keys)
...
pip install mem0
```
Add Respan gateway to the Mem0 client as an LLM provider. You can go to the [Models page](https://platform.keywordsai.co/platform/models?sort_by=model_name) to find the available models.
...
We recommend using the [Respan SDK](https://github.com/keywordsai/keywordsai-sdk) for better type checking and autocomplete.
