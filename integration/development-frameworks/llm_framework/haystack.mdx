...
```bash
export RESPAN_API_KEY="your-keywords-ai-key"
```
...
Use [Respan parameters](/api-endpoints/develop/gateway/chat-completions#keywords-ai-parameters) for advanced features:
