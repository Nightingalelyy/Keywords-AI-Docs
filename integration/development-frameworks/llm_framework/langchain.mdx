...
[Respan parameters](/api-endpoints/develop/gateway/chat-completions#keywords-ai-parameters) can be passed using `extra_body` for better handling and customization.
