...
1. Create an API key in [Respan platform](https://platform.keywordsai.co/platform/api/api-keys).
...
respan_params_header = {
    "X-Data-Keywordsai-Params": b64encode(json.dumps(respan_params).encode()).decode(),
}
