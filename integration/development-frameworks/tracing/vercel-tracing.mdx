...
```bash
npx create-next-app --example https://github.com/Keywords-AI/keywordsai-example-projects/tree/main/vercel_ai_next_openai my-respan-app
```

```bash
yarn create next-app --example https://github.com/Keywords-AI/keywordsai-example-projects/tree/main/vercel_ai_next_openai my-respan-app
```
```bash
pnpm create next-app --example https://github.com/Keywords-AI/keywordsai-example-projects/tree/main/vercel_ai_next_openai my-respan-app
```
...
3. Start chatting and check your [Respan dashboard](https://platform.keywordsai.co/platform/dashboard)
...
{/* ## Prerequisites
- Vercel AI SDK
- [Respan API key](https://platform.keywordsai.co/platform/api/api-keys)
