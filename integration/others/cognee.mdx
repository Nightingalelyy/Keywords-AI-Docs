...
- Python 3.10+
- Respan API key ([Get yours here](https://keywordsai.co))
...
observe = get_observe()  # returns Respan decorator when MONITORING_TOOL=keywordsai
...
2. Open your [Respan dashboard](https://keywordsai.co)
