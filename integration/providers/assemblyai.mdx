...
### Respan params
You can pass any [Respan observability parameters](https://docs.keywordsai.co/api-endpoints/develop/gateway/chat-completions#observability-parameters) in the `metadata` field.
