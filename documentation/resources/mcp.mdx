  ...
  <Tab title="Public HTTP (Recommended)">
    ...
    <Steps>
      <Step title="Get your API key">
        Get your Respan API key from [platform.keywordsai.co](https://platform.keywordsai.co/platform/api/api-keys).
      </Step>
    ...
    ```json
    {
      "mcpServers": {
        "keywords-ai": {
          ...
          "headers": {
            "Authorization": "Bearer your_keywords_ai_api_key",
            "keywords-api-base-url": "https://endpoint.respan.ai/api"
          }
        }
      }
    }
    ...
    ```json
    {
      "mcpServers": {
        "keywords-ai": {
          ...
          "env": {
            "KEYWORDS_API_KEY": "your_keywords_ai_api_key",
            "KEYWORDS_API_BASE_URL": "https://endpoint.respan.ai/api"
          }
        }
      }
    }
